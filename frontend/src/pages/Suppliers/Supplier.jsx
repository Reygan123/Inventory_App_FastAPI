...
import { read_supplier, delete_supplier, create_supplier } from '../../fetching/supplier';
...
const Supplier = () => {
    ...
    const fetchSupplier = async () => {
        try {
            ...
            console.log("Respons", supplier.data);
        } catch (error) {
            console.log(error);
        }
    };
    ...
    const handleSubmit = async () => {
        try {
            ...
            const response = await create_supplier(payload);
    ...
    const handleDelete = async () => {
        try {
            await delete_supplier(idSupplier)
            setIsOpen(false);
            await fetchSupplier();
        } catch (error) {
            console.log(error)
        ...
        <div className='flex w-full'>
            ...
            <div className='text-xs md:text-sm lg:text-xs 2xl:text-md m-4 w-full'>
                <div className='flex justify-between w-full my-2'>
                    <h2 className='text-sm md:text-md lg:text-lg 2xl:text-lg font-bold'>List Supplier</h2>
                ...
                <>
                    ...
                    <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full">
                        <div className="relative p-4 rounded-md bg-white flex flex-col justify-center items-center top-1/2 left-1/2 transform -translate-x-1/2 w-2/6">
                            <h1 className='font-bold text-sm md:text-md lg:text-md 2xl:text-lg mb-4'>Form Tambah Supplier</h1>
